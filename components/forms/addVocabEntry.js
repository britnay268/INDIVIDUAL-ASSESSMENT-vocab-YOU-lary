...
const addVocabEntry = (obj = {}) => {
  ...
  <form id="" class="mb-4">
   <div class="mb-3">
     ...
     <input type="text" class="form-control" id="add-vocab-title" placeholder="Enter a word or phrase" alue="${obj.title || ''}">
   </div>
   <div class="mb-3">
     <label for="vocab-definition" class="form-label">Definition</label>
     <input type="text" class="form-control" id="add-vocab-definition" placeholder="Enter a definition" alue="${obj.definition || ''}">
  </div>
